    ...
    for Question in all_questions:
        ...
        if text: 
            ...
            if not prev_answer or overwrite_previous_answers:
                ...
                elif ('hear' in label or 'come across' in label) and 'this' in label and ('job' in label or 'position' in label): answer = "https://github.com/Divyanshutiwari102/Auto_job_applier_linkedIn"
...
def main() -> None:
    ...
    try:
        ...
        quotes = choice([
            "Never quit. You're one step closer than before. - Divyanshu Tiwari", 
            "All the best with your future interviews, you've got this. - Divyanshu Tiwari", 
            "Keep up with the progress. You got this. - Divyanshu Tiwari", 
            "If you're tired, learn to take rest but never give up. - Divyanshu Tiwari",
