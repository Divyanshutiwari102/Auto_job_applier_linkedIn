...
search_terms = ["Software Developer Intern", "Backend Developer Intern", "Java Developer Intern", "Full Stack Developer Intern", "Spring Boot Developer", "React Developer Intern", "Software Engineer Intern", "Junior Software Developer", "Java Spring Boot Developer", "Full Stack Java Developer"]
...
bad_words = [".NET", "Embedded Programming", "PHP", "Ruby", "CNC", "COBOL", "Mainframe", "5+ years", "7+ years", "10+ years"]                     # (dynamic multiple search) or leave empty as []. Case Insensitive.
